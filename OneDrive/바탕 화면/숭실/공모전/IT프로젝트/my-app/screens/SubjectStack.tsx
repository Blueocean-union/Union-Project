...
import QuizSelectScreen from './QuizSelectScreen';
import QuizRoomScreen from './QuizRoomScreen';
...
export default function SubjectStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="QuizSelect"
        component={QuizSelectScreen as unknown as React.ComponentType<any>}
      />
      <Stack.Screen
        name="QuizRoom"
        component={QuizRoomScreen as unknown as React.ComponentType<any>}
      />
      <Stack.Screen
        name="QuizResult"
        component={QuizResultScreen as unknown as React.ComponentType<any>}
      />
    </Stack.Navigator>
  );
}
